...
{
	[TestFixture]
	public class IterativeBinarySearchTreeStudentTest
	{
		...
		{
			yield return new TestCaseData(new List<Student> { first }).Returns(new List<Student> { first  });
			yield return new TestCaseData(new List<Student> { second }).Returns(new List<Student> { second  });
			yield return new TestCaseData(new List<Student> { third }).Returns(new List<Student> { third  });
			yield return new TestCaseData(new List<Student> { fourth }).Returns(new List<Student> { fourth  });
			yield return new TestCaseData(new List<Student> { fifth }).Returns(new List<Student> { fifth  });

			yield return new TestCaseData(new List<Student> { second, first  }).Returns(new List<Student> { first , second });
			yield return new TestCaseData(new List<Student> { first , second, third }).Returns(new List<Student> { first , second, third });
			yield return new TestCaseData(new List<Student> { second, first , third }).Returns(new List<Student> { first , second, third });
			yield return new TestCaseData(new List<Student> { first , first , first , first , first  }).Returns(new List<Student> { first , first , first , first , first  });
			yield return new TestCaseData(new List<Student> { fifth, fourth, third, second, first  }).Returns(new List<Student> { first , second, third, fourth, fifth });
			yield return new TestCaseData(new List<Student> { second, first , fourth, third, fifth }).Returns(new List<Student> { first , second, third, fourth, fifth });
			yield return new TestCaseData(new List<Student> { fourth, fourth, fourth, second, second, first , first , first , first  }).Returns(new List<Student> { first , first , first , first , second, second, fourth, fourth, fourth });
		...
		{
			IterativeBinarySearchTree<Student> tree = new IterativeBinarySearchTree<Student>(items, comparer);
			List<Student> result = new List<Student>();
		...
		private IEnumerable<TestCaseData> TestCasesCreateTreeFromCollectionWithComparer()
		{
			...
			yield return new TestCaseData(new List<Student> { first , first , first , first , first  }, new DataComparer<Student>(OrderType.Inverse)).
				Returns(new List<Student> { first , first , first , first , first  });
			yield return new TestCaseData(new List<Student> { first , second, third }, new DataComparer<Student>(OrderType.Inverse)).
				Returns(new List<Student> { third, second, first  });
			yield return new TestCaseData(new List<Student> { second, first , third }, new DataComparer<Student>(OrderType.Inverse)).
				Returns(new List<Student> { third, second, first  });
			yield return new TestCaseData(new List<Student> { fifth, fourth, third, second, first  }, new DataComparer<Student>(OrderType.Inverse)).
				Returns(new List<Student> { fifth, fourth, third, second, first  });
			yield return new TestCaseData(new List<Student> { second, first , fourth, third, fifth }, new DataComparer<Student>(OrderType.Inverse)).
				Returns(new List<Student> { fifth, fourth, third, second, first  });
			...
			yield return new TestCaseData(new List<Student>(), new DataComparer<Student>(OrderType.Direct)).
				Returns(new List<Student>());
			yield return new TestCaseData(new List<Student> { first , first , first , first , first  }, new DataComparer<Student>(OrderType.Direct)).
				Returns(new List<Student> { first , first , first , first , first  });
			yield return new TestCaseData(new List<Student> { first , second, third }, new DataComparer<Student>(OrderType.Direct)).
				Returns(new List<Student> { first , second, third });
			yield return new TestCaseData(new List<Student> { second, first , third }, new DataComparer<Student>(OrderType.Direct)).
				Returns(new List<Student> { first , second, third });
			yield return new TestCaseData(new List<Student> { fifth, fourth, third, second, first  }, new DataComparer<Student>(OrderType.Direct)).
				Returns(new List<Student> { first , second, third, fourth, fifth });
			yield return new TestCaseData(new List<Student> { second, first , fourth, third, fifth }, new DataComparer<Student>(OrderType.Direct)).
				Returns(new List<Student> { first , second, third, fourth, fifth });
			yield return new TestCaseData(new List<Student> { fourth, fourth, fourth, second, second, first , first , first , first  }, new DataComparer<Student>(OrderType.Direct)).
		...
		{
			yield return new TestCaseData(new List<Student> { first  }, first ).Returns(new List<Student> { first , first  });
			yield return new TestCaseData(new List<Student> { first , second }, first ).Returns(new List<Student> { first , first , second });
			yield return new TestCaseData(new List<Student> { first , second }, second).Returns(new List<Student> { first , second, second });
			yield return new TestCaseData(new List<Student> { first , second }, third).Returns(new List<Student> { first , second, third });
			yield return new TestCaseData(new List<Student>(), first ).Returns(new List<Student> { first  });
		...
		{
			yield return new TestCaseData(new List<Student> { second, first , fourth, third, fourth, fifth }, new DataComparer<Student>(OrderType.Inverse)).Returns(first );
			yield return new TestCaseData(new List<Student> { second, first , fourth, third, fourth, fifth }, new DataComparer<Student>(OrderType.Direct)).Returns(fifth);
		...
		{
			yield return new TestCaseData(new List<Student> { second, first , fourth, third, fourth, fifth }, new DataComparer<Student>(OrderType.Direct)).Returns(fifth);
			yield return new TestCaseData(new List<Student> { second, fourth, third, fourth, fifth }, new DataComparer<Student>(OrderType.Direct)).Returns(fifth);

			yield return new TestCaseData(new List<Student> { second, first , fourth, third, fourth, fifth }, new DataComparer<Student>(OrderType.Inverse)).Returns(fifth);
			yield return new TestCaseData(new List<Student> { second, fourth, third, fourth, fifth }, new DataComparer<Student>(OrderType.Inverse)).Returns(fifth);

			yield return new TestCaseData(null, new DataComparer<Student>(OrderType.Direct)).Throws(typeof(ArgumentNullException));
		}
		...
		{
			yield return new TestCaseData(new List<Student> { second, first , fourth, third, fourth, fifth }, new DataComparer<Student>(OrderType.Direct)).Returns(first );
			yield return new TestCaseData(new List<Student> { second, fourth, third, fourth, fifth }, new DataComparer<Student>(OrderType.Direct)).Returns(second);
		...
		private IEnumerable<TestCaseData> TestCasesGetMin()
		{
			...
			yield return new TestCaseData(new List<Student> { second, first , fourth, third, fourth, fifth }, new DataComparer<Student>(OrderType.Inverse)).Returns(first );
			yield return new TestCaseData(new List<Student> { second, fourth, third, fourth, fifth }, new DataComparer<Student>(OrderType.Inverse)).Returns(second);
