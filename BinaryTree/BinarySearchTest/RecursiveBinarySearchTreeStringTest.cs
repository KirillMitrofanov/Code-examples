...
{
	[TestClass]
	public class RecursiveBinarySearchTreeStringTest
	{
		[Test]
		...
		{
			RecursiveBinarySearchTree<string> tree = new RecursiveBinarySearchTree<string>(items);
		...
		{
			RecursiveBinarySearchTree<string> tree = new RecursiveBinarySearchTree<string>(items, comparer);
			List<string> result = new List<string>();
		...
		{
			RecursiveBinarySearchTree<string> tree = new RecursiveBinarySearchTree<string>(items) {item};
		...
		{
			RecursiveBinarySearchTree<string> tree = new RecursiveBinarySearchTree<string>(items, comparator);
